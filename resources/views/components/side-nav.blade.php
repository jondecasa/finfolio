@php
    $items = [
        ...
        ['route' => 'debts.index', 'match' => 'debts.*', 'label' => 'Debts', 'icon' => 'M4 19h16M6 15v4M10 11v8M14 7v12M18 4v15'],
...
<aside class="side-nav">
    ...
    <nav class="flex flex-1 flex-col gap-1">
        @foreach ($items as $item)
            <a href="{{ route($item['route']) }}" @class(['side-nav-link', 'active' => request()->routeIs($item['match'] ?? $item['route'])])>
